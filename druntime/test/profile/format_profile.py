...
def format_profile(input_lines):
    ...
    for line in input_lines:
        ...
        # Format output and remove trailing spaces
        formatted_line = (
            f"{bytes_alloc:<16} | {allocs:<11} | {type_:<27} | {func:<10} | {file_path:<20} | {line_num:<4}".rstrip()
        )
...
if __name__ == "__main__":
    ...
    for line in format_profile(sys.stdin):
        print(line.rstrip())  # Ensures output has no trailing spaces
